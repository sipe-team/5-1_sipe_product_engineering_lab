...
- 즉 이 78%는 "타겟 세그먼트 크기의 상한 추정"으로 읽어야 하며, 정확한 핵심 타겟은 **"결제 유지 중이면서 최근 월 미참여인 유료자"**다. 이 정제된 수치는 baseline 확보 시 산출 가능 (Open Questions #1, #신규 문항).
